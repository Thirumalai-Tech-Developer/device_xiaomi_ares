...
public class TriggerUtils {
    ...
    public void loadSoundResource() {
        ...
        initSoundPool();
        SOUNDS_MAP.put("classic-0-0", load(R.raw.bye_bye));
        SOUNDS_MAP.put("classic-1-0", load(R.raw.bye_bye));
        SOUNDS_MAP.put("classic-0-1", load(R.raw.its_me_goku));
        SOUNDS_MAP.put("classic-1-1", load(R.raw.its_me_goku));
        SOUNDS_MAP.put("bullet-0-0", load(R.raw.bye_bye));
        SOUNDS_MAP.put("bullet-1-0", load(R.raw.bye_bye));
        SOUNDS_MAP.put("bullet-0-1", load(R.raw.bankai));
        SOUNDS_MAP.put("bullet-1-1", load(R.raw.bankai));
        SOUNDS_MAP.put("current-0-0", load(R.raw.bye_bye));
        SOUNDS_MAP.put("current-1-0", load(R.raw.bye_bye));
        SOUNDS_MAP.put("current-0-1", load(R.raw.namikaze_minato));
        SOUNDS_MAP.put("current-1-1", load(R.raw.namikaze_minato));
        SOUNDS_MAP.put("wind-0-0", load(R.raw.bye_bye));
        SOUNDS_MAP.put("wind-1-0", load(R.raw.bye_bye));
        SOUNDS_MAP.put("wind-0-1", load(R.raw.instant_transmission));
        SOUNDS_MAP.put("wind-1-1", load(R.raw.instant_transmission));
